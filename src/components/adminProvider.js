...
export default function AdminProvider({ children }) {
  ...
  const handleTabClick = (event, tabName) => {
    ...
    return navigate(`/${tabName.toLowerCase()}`); // Update the URL based on the clicked tab
  };
          ...
          <div className="px-3 py-3 lg:px-5 lg:pl-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center justify-start">
                ...
                >
                  <img src="" className="h-6 mr-2" alt="" />
                ...
                >
                  ...
                  <img src="" className="h-6 mr-2" alt="" />
                  <span className="self-center whitespace-nowrap">Welcome {user && user.claims.name}</span>
                </a> */}
              ...
              <div className="flex items-center">
                ...
                <Link
                  to="/"
                  className="hidden sm:inline-flex ml-5 text-white bg-purple-800 hover:bg-purple-900 focus:ring-4 focus:ring-purple-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center items-center mr-3"
                >
                  {/* <svg
                  ...
                  <ul className="space-y-2 pb-2">
                    ...
                    {isAdmin && (isAdmin || isSubAdmin) && (
                      <li>
                        <Link
                          to="usercrud"
                          onClick={(e) => handleTabClick(e, "usercrud")}
                    ...
                    {isAdmin && (
                      <li>
                        <Link
                          to="rolecrud"
                          onClick={(e) => handleTabClick(e, "rolecrud")}
                    ...
                    {isCustomer && (
                      <li>
                        <Link
                          to="bookappointment"
                          onClick={(e) => handleTabClick(e, "bookappointment")}
                          className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group "
                        >
                    ...
                    {isAdmin && (
                      <li>
                        <Link
                          ...
                          onClick={(e) =>
                            handleTabClick(e, "appointment-management")
                          }
                          className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group "
                        >
                          {/* <FontAwesomeIcon */}
